...
c=main_neighbourhood$neighbourhood_cleansed

listings_neigh<-listings2 %>% 
  group_by(neighbourhood_cleansed) %>% 
  filter(neighbourhood_cleansed==c) %>% 
...
## Center more expensive....confirm the importance of location (location! location! location!)
```
