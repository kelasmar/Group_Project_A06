...
Since the vast majority of the observations in the data are one of the top four or five property types, we would like to create a simplified version of `neighbourhood cleansed` variable that has 5 categories: the top four categories and `Other`. 
...
listings2 <- listings2 %>%
  mutate(neighbourhood_cleansed = case_when(
    neighbourhood_cleansed %in% c("De Baarsjes - Oud-West",
                         ...
                         "Centrum-West",	
                         "Centrum-Oost") ~ neighbourhood_cleansed, 
    TRUE ~ "Other"))
...
The graph shows that the neighbourhoods are quite evenly distributed in terms of price and might be less of an interesting indicator than we initially expected.
